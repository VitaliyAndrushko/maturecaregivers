...
router.post('/send', function(req, res, next) {
    var transporter = nodemailer.createTransport({
        service: 'Gmail',
        auth: {
            user: 'maturecaregivers50@gmail.com',
            pass: 'maturecaregivers50+'
        }
    });

    var mailOptions = {
        from: 'Mature Caregivers <maturecaregivers50@gmail.com>',
        to: 'support@maturecaregivers.com',
    ...
    transporter.sendMail(mailOptions, function(error, info) {
        if(error) {
            ...
            // res.redirect('/');
            res.render('findform', { title: 'Find caregivers', success: true });
        }
    });
